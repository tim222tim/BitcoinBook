...
namespace BitcoinBook.Test
{
    ...
    {
        readonly GetCompactFiltersMessage message = new(FilterType.Basic, 0x01020304, Cipher.ToBytes("0000000000000000007962066dcd6675830883516bcf40047d42740a85eb2919"));
