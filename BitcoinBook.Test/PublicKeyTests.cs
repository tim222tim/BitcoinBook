    ...
    public class PublicKeyTests
    {
        ...
        public void SecUncompressedFormatTest()
        {
            Assert.Equal(
                ...
                new PrivateKey(5000).PublicKey.ToSecUncompressedString());
            Assert.Equal(
                "04027f3da1918455e03c46f659266a1bb5204e959db7364d2f473bdf8f0a13cc9dff87647fd023c13b4a4994f17691895806e1b40b57f4fd22581a4f46851f3b06",
                new PrivateKey((BigInteger)Math.Pow(2018, 5)).PublicKey.ToSecUncompressedString());
            Assert.Equal(
                "04d90cd625ee87dd38656dd95cf79f65f60f7273b67d3096e68bd81e4f5342691f842efa762fd59961d0e99803c61edba8b3e3f7dc3a341836f97733aebf987121",
                new PrivateKey("0deadbeef12345").PublicKey.ToSecUncompressedString());
        }
        ...
        public void SecCompressedFormatTest()
        {
            Assert.Equal(
                ...
                new PrivateKey(5001).PublicKey.ToSecCompressedString());
            ...
            Assert.Equal(
                ...
                new PrivateKey("0deadbeef54321").PublicKey.ToSecCompressedString());
        }
