...
namespace BitcoinBook.Test
{
    public class TransactionHasherTests
    {
        ...
        {
            Assert.ThrowsAsync<IndexOutOfRangeException>(async () => await IntegrationSetup.Mainnet.Hasher.ComputeSigHash(transaction, inputIndex, SigHashType.All));
        }
